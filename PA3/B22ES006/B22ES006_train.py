...
save_test_data_without_labels(test_X, os.path.join(current_directory, "test.txt"))'''
...
if __name__ == "__main__":
    ...
    # Save trained weights to weights.txt
    save_weights(perceptron.weights, "weights.txt")
